...
- MUI X Community forces pagination and limits each page to 100 rows. Its
  runtime measurements are excluded from the continuous 50,000-row
  virtualization comparison; only its bundle result and live paginated fixture
  are retained. MUI Pro would require a separate licensed adapter.
